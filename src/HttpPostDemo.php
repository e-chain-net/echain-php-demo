...
function http_post($url,$request,$mechatNo) : object{
  global $rsa;
...
$response = http_post($query_url,$blockNumberReq,$mechatNo);
echo '查询 blockNumber' . '\n';
echo_response($response);
$response = http_post($query_url,$blockLimitReq,$mechatNo);
echo '查询 blockLimit' . '\n';
echo_response($response);
$response = http_post($query_url,$getTxReceiptReq,$mechatNo);
echo '查询 transactionReceipt' . '\n';
echo_response($response);
$response = http_post($sendtx_url,$sendTxReq,$mechatNo);
echo '交易发送' . '\n';
echo_response($response);
